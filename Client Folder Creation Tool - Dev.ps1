...
#Static Variables
$sourcePath = "P:\2021\ClientTemplate"
$targetPath = "P:\2021"
...
#User Warning
$outputBox.Text = ( "Warning: This tool requires access to the P:\ Drive. Make sure it is connected and available before using this tool. `r`n" )
...
function checkDrives{
    if(!(Test-Path -Path $sourcePath)){
       ...
       $outputBox.AppendText("P:\ Connected")
    }
}
